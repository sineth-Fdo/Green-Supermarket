        ...
        <div className="category-more-hero">
            ...
            <div className="block-container">
                ...
                <div className="right-block">
                    ...
                    <div className="right-cate common"  onClick={() => {navigate('/shop')}}>
